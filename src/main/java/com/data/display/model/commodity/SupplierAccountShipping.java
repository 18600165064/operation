...
public class SupplierAccountShipping extends ParentComment implements Serializable{
	 ...
	 * 特殊区域
	 */
	private List<SupplierAccountShippingSettings> supplierAccountShippingSettings;
	/**
	 *不发货地区 
	 */
	...
	public List<SupplierAccountShippingSettings> getSupplierAccountShippingSettings() {
		return supplierAccountShippingSettings;
	}
	public void setSupplierAccountShippingSettings(List<SupplierAccountShippingSettings> supplierAccountShippingSettings) {
		this.supplierAccountShippingSettings = supplierAccountShippingSettings;
	}
