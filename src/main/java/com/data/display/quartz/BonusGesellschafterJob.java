 ...
 * 股东池分红
 */
public class BonusGesellschafterJob extends QuartzJobBean {

    private static Logger _log = LoggerFactory.getLogger(BonusGesellschafterJob.class);
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        try{
            ...
            _log.error("股东分红错误"+ Json.toJson(e));
        }
    }
