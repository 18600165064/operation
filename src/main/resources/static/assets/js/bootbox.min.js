...
!function (t, e) {
        ...
        var n, i, l, s = {
            className: 'bootbox-' + t, buttons: function (t, e) {
                for (var o = {}, a = 0, r = t.length; a < r; a++) {
                    ...
                    o[i] = {label: (s = l, c = e, void 0, p = b[c], p ? p[s] : b.en[s])}
                }
                var s, c, p;
                return o
            }(e, r)
    ...
    return d.locales = function (t) {
        ...
        switch (n = p(f.inputs[r.inputType]), r.inputType) {
            ...
            case'email':
            case'password':
                n.val(r.value), r.placeholder && n.attr('placeholder', r.placeholder), r.pattern && n.attr('pattern', r.pattern), r.maxlength && n.attr('maxlength', r.maxlength), r.required && n.prop({required: !0});
                break;
            case'date':
            case'time':
            case'number':
            ...
            case'select':
                ...
                r.placeholder && n.attr('placeholder', r.placeholder), r.required && n.prop({required: !0}), r.multiple && n.prop({multiple: !0}), w(a, function (t, e) {
                    var o = n;
    ...
    }, d.addLocale('zh_CN', {OK: '确定', CANCEL: '取消', CONFIRM: '确定'}), d
});