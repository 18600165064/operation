                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th style="width:5%;">合伙人昵称</th>
                                    <th style="width:6%;">合伙人ID</th>
                                    <th style="width:7%;">累计一级总人数</th>
                                    <th style="width:7%;">累计二级总人数</th>
                                    <th style="width:7%;">当日新增一级人数</th>
                                    <th style="width:7%;">当日新增二级人数</th>
                                    <th style="width:6%;">累计总单数</th>
                                    <th style="width:7%;">当日新增单数</th>
                                    <th style="width:7%;">当日退货单数</th>
                                    <th style="width:7%;">团队累计退货率</th>
                                    <th style="width:6%;">昨日分红</th
                                </tr>
                                </thead>
                                <tbody>
