...
<script>
    ...
    $.get('${ctx!}/data/getUserActive?strDate=' + strDate + '&endDate=' + endDate).done(function (data) {
        // 填入数据
        myChart.setOption({
            tooltip: {
                trigger: 'axis'
    ...
    function select() {
        ...
        $.get('${ctx!}/data/getUserActive?strDate=' + strDate1 + '&endDate=' + endDate1).done(function (data) {
            // 填入数据
            myChart.setOption({
                tooltip: {
                    trigger: 'axis'
    ...
    function sameDay(){
        ...
        var sameDate = $("#sameDate").val();
           $.get('${ctx!}/data/getUserActive?strDate=' + sameDate + '&endDate=' + sameDate).done(function (data) {
               // 填入数据
               myChart.setOption({
                   tooltip: {
                       trigger: 'axis'
