                            ...
                            <form id="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%" >
                                            <input type="text"  class="form-control validate[required[maxSize[5]]" id="spu_keyword" name="spu_keyword" placeholder="关键字，最多5个汉字" data-errormessage-value-missing="关键字不能为空" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%" >
                                            <input type="text"  class="form-control validate[required,custom[onlyNumberTwo],min[0.1]]" id="price" name="price" placeholder="单买价格" data-errormessage-value-missing="单买价格不能为空" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
