...
var table = $('#datatable').DataTable({
	    ...
	    "serverSide": true,
	    "ajax": {
	        "url": "${ctx!}/supplierAccountShipping/getSupplierAccountShippingData?s_id="+_id+"",
...
function handle(data){
    ...
    function addSupplierAccountShipping(){
 		window.location.href = "${ctx!}/supplierAccountShipping/addSupplierAccountShipping?s_id="+_id+"";
 	}
