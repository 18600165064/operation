	    ...
	    "columns": [
	        ...
	        },
	        {
	        	...
	        	"render":function(data, type, row) {
	        		...
	        		if(row.on_sale == 1){
        				return '<a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" onclick="seecontent('+data+')">查看</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/product/editSku?id='+data+'&status=0\">编辑</a>';
	        		}else{
	        			return '<a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" onclick="seecontent('+data+')">查看</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href="${ctx!}/product/editSku?id='+data+'&status=1">编辑</a>';
	        		}
...
function seecontent(id) {
    window.location.href = "${ctx!}/product/seecontent?id="+id+"";
}
