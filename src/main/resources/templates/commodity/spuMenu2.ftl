...
var table = $('#datatable').DataTable({
	    ...
	    "serverSide": true,
	    "ajax": {
	        "url": "${ctx!}/spuCommodity/getExamineSpuData",
...
//                         	return '<a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/spuCommodity/examineSpu?id='+data+'\">审核</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/product/addProduct?spuid='+data+'\">添加SKU</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" disabled="disabled" \">维护中</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/spuCommodity/editSpu?id='+data+'\">编辑</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/materail/addMaterail?spuid='+data+'\">添加素材</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/materail/materailMenu?spuid='+data+'\">素材列表</a> <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" href=\"${ctx!}/topLevel/topLevelMneu?spuid='+data+'\">顶级账户</a>';
// 	        			}
	        	 }
	        }
	    ]
	});
// <a class="btn btn-danger btn-xs ml-5 js-delete" data-id="'+data+'" onclick="delSpu('+data+')"\">删除</a> 
