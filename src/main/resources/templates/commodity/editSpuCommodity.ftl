...
$(document).ajaxSend(function(e, xhr, options) { 
	...
	$('#img7').on('filepredelete', function(event, key) {
		$("#success_image").val("");
	})

	$('#img8').on('filepredelete', function(event, key) {
		$("#success_gif_image").val("");
	})
			...
			var menuJson = JSON.parse(result);
				...
				$("#img6").fileinput({
				 ...
				 $("#img7").fileinput({
					 ...
					 initialPreviewConfig:[{
						 url: '${ctx!}/spuCommodity/delOssPhoto?filePath='+menuJson.success_image+''// 预展示图片的删除调取路径
					 }]
				 })
				 ...
				 $("#img8").fileinput({
					 ...
					 initialPreviewConfig:[{
						 url: '${ctx!}/spuCommodity/delOssPhoto?filePath='+menuJson.success_gif_image+''// 预展示图片的删除调取路径
					 }]
				 })
...
function save(){
	...
	$("#third_category").attr("disabled",false);
		...
		// var _successImage = $("#success_image").val();
		// var _successName = $("#img7").val();
		// if(_successImage == null || _successImage == '' || _successImage == 'undefind'){
		...
		//
		//
		// var _gifImage = $("#success_gif_image").val();
		// var _gifName = $("#img8").val();
		// if(_gifImage == null || _gifImage == '' || _gifImage == 'undefind'){
