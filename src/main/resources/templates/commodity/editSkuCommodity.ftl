                              ...
                              <form id="form" class="form-horizontal" method="post" enctype="multipart/form-data">
						            <table class="table table-bordered">
						              ...
						              <tr>
						                ...
						                <td width="30%" >
							                  <input type="text"  class="form-control validate[required]" id="commission" name="commission" placeholder="佣金" data-errormessage-value-missing="佣金不能为空" readonly="true"/>
						                </td>
						              </tr>
						              <tr>
									  ...
									  <tr>
										  ...
										  <td width="30%" >
											  <select class="form-control"  id="settle_id" name="settle_id">
...
var _status = "${status!""}";
if (_status == 1){
	$("#default_price").attr("readOnly",true);
	$("#default_number").attr("readOnly",true);
	$("#sub_dis_fee").attr("readOnly",true);
	$("#sub_dis_value").attr("readOnly",true);
	$("#shipping_id").attr("disabled",true);
	$("#settle_id").attr("disabled",true);
				...
				　			}
				  ...
				  $("#img2").fileinput({
					    ...
					    initialPreviewConfig:[{
														url: '${ctx!}/spuCommodity/delOssPhoto?filePath='+menuJson.sku_image+''// 预展示图片的删除调取路径
													}]
					})
...
function save(){
	...
	var _settle = $("#settle_id").val();
	if(_settle == null || _settle == '' || _settle == 'undefind'){
		bootbox.alert("请先添加结算运费模板");
		return false;
	}
			...
			success : function(data) {
					if (data.draw == 1) {
						bootbox.alert(data.error, function() {
							window.location.href = "${ctx!}/product/skuMenu";
						});
					}else{
