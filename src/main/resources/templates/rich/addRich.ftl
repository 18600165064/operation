                              ...
                              <form id="form" class="form-horizontal" method="post" enctype="multipart/form-data">
						            <table class="table table-bordered">
						              ...
						              <tr>
						                ...
						                <td width="30%" >
							                  <select class="form-control"  id="type" name="type" onchange="changeClass()">
...
function changeClass(){
	...
	var _classValue = $("#type").val();
	if(_classValue == 5 || _classValue == 6 || _classValue == 7 || _classValue == 14){
		$("#img2").fileinput({
			language : 'zh',
		    uploadUrl : "#",
		    showPreview : true, //是否显示预览
...
//		         actionZoom:''   //去除上传预览缩略图中的查看详情预览的缩略图标。
	...
	}else if (_classValue == 11 || _classValue == 3 || _classValue == 12){
		$("#img2").fileinput({
			language : 'zh',
			uploadUrl : "#",
			showPreview : true, //是否显示预览
